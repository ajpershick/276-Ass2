...
class EnrollsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enroll" do
    assert_difference('Enroll.count') do
      post enrolls_url, params: { enroll: { course_id: @enroll.course_id, lettergrade: @enroll.lettergrade, percentage: @enroll.percentage, student_id: @enroll.student_id } }
    end
  ...
  test "should update enroll" do
    patch enroll_url(@enroll), params: { enroll: { course_id: @enroll.course_id, lettergrade: @enroll.lettergrade, percentage: @enroll.percentage, student_id: @enroll.student_id } }
